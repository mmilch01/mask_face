...
nrg_improc_tools="maskface_setup.sh run_facemasking2_xnat mask_face mask_face_nomatlab cmpanalyze analyze2dcm dcm2analyze dcm_nii nii_img hdbet_wrapper dcm2nii2013 dcm2nii.ini xnat2loc dcm_sort dcminfo"
